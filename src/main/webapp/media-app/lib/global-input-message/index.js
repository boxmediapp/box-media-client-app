...
Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _socket=require("socket.io-client");var _socket2=_interopRequireDefault(_socket);
var _util=require("./util");
var _codedataUtil=require("./codedataUtil");function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var


GlobalInputMessageConnector=function(){_createClass(GlobalInputMessageConnector,[{key:"log",value:function log(
message){
...
function GlobalInputMessageConnector(){_classCallCheck(this,GlobalInputMessageConnector);
...
}_createClass(GlobalInputMessageConnector,[{key:"isConnected",value:function isConnected()
...
}},{key:"setCodeAES",value:function setCodeAES(
codeAES){
...
}},{key:"onRegisterPermission",value:function onRegisterPermission(
registerPermistion,options){
...
}},{key:"onRegistered",value:function onRegistered(
...
}},{key:"processInputPermission",value:function processInputPermission(
...
}},{key:"grantInputPermission",value:function grantInputPermission(


inputPermissionMessage,options){
var existingSameSenders=this.connectedSenders.filter(function(s){return s.client===inputPermissionMessage.client;});
...
}},{key:"sendInputPermissionGrantedMessage",value:function sendInputPermissionGrantedMessage(
inputPermissionMessage,options){
this.log("*****sendInputPermissionGrantedMessagen options:"+JSON.stringify(options));
var inputPermissionResult=_extends({},inputPermissionMessage);
if(options.initData){
...
}},{key:"sendInputPermissionDeniedMessage",value:function sendInputPermissionDeniedMessage(
inputPermissionMessage,reason){
...
}},{key:"sendInputPermissionResult",value:function sendInputPermissionResult(
inputPermissionResult){
...
}},{key:"onInputPermissionResult",value:function onInputPermissionResult(

inputPermissionResultMessage,options){
...
}},{key:"onOutputMessageReceived",value:function onOutputMessageReceived(
messagedata,options){
if(options.onOutputMessageReceived&&options.inputAES){
var outputMessageString=(0,_util.decrypt)(messagedata.data,options.inputAES);
...
}},{key:"sendOutputMessage",value:function sendOutputMessage(
outputMessage){
if(!this.isConnected()){
...
}},{key:"buildInputSender",value:function buildInputSender(
inputPermissionMessage,options){
var that=this;
var inputSender={
...
var matchedSenders=that.connectedSenders.filter(function(s){return s.client===leaveMessage.client;});
...
disconnectSender:function disconnectSender(inputSender){
...
that.connectedSenders=that.connectedSenders.filter(function(s){return s.client!==inputSender.client;});
}};


return inputSender;
}},{key:"_onInput",value:function _onInput(
...
}},{key:"sendInputMessage",value:function sendInputMessage(
...
}},{key:"changeGlobalInputFieldData",value:function changeGlobalInputFieldData(
globalInputdata,index,value){
if(!globalInputdata){
...
}},{key:"buildOptionsFromInputCodedata",value:function buildOptionsFromInputCodedata(



codedata,options){
return _codedataUtil.codedataUtil.buildOptionsFromInputCodedata(this,codedata,options);
}},{key:"buildInputCodeData",value:function buildInputCodeData()
{var data=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};
return _codedataUtil.codedataUtil.buildInputCodeData(this,data);
}},{key:"buildAPIKeyCodeData",value:function buildAPIKeyCodeData()
{var data=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};
return _codedataUtil.codedataUtil.buildAPIKeyCodeData(this,data);
}},{key:"buildSecurityGroupCodeData",value:function buildSecurityGroupCodeData()
{var data=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};
return _codedataUtil.codedataUtil.buildSecurityGroupCodeData(this,data);
}},{key:"buildCodeAESCodeData",value:function buildCodeAESCodeData()
{var data=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};
return _codedataUtil.codedataUtil.buildCodeAESCodeData(this,data);
}},{key:"processCodeData",value:function processCodeData(
encryptedcodedata,options){
return _codedataUtil.codedataUtil.processCodeData(this,encryptedcodedata,options);
}}]);return GlobalInputMessageConnector;}();exports.default=GlobalInputMessageConnector;
},{"./codedataUtil":2,"./util":3,"socket.io-client":35}],2:[function(require,module,exports){
Object.defineProperty(exports,"__esModule",{value:true});exports.codedataUtil=undefined;var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};
var _util=require("./util");
...
{
return _extends(buildOptions,options);
}

},
buildInputCodeData:function buildInputCodeData(connector){var data=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};
var codedata=_extends({},data,{
url:connector.url,
...
buildAPIKeyCodeData:function buildAPIKeyCodeData(connector){var data=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};
var codedata=_extends({},data,{
...
buildSecurityGroupCodeData:function buildSecurityGroupCodeData(connector){var data=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};
var codedata=_extends({},data,{
...
buildCodeAESCodeData:function buildCodeAESCodeData(connector){var data=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};
var codedata=_extends({},data,{
codeAES:connector.codeAES,
action:"settings"});

return"C"+(0,_util.encrypt)("J"+JSON.stringify(codedata),"LNJGw0x5lqnXpnVY8");
},
...
try{
decryptedContent=(0,_util.decrypt)(encryptedContent,"LNJGw0x5lqnXpnVY8");
}
catch(error){
...
try{
decryptedContent=(0,_util.decrypt)(encryptedContent,connector.codeAES);
}
catch(error){
...
Object.defineProperty(exports,"__esModule",{value:true});exports.generatateRandomString=generatateRandomString;exports.



encrypt=encrypt;exports.


decrypt=decrypt;function generatateRandomString(){var length=arguments.length>0&&arguments[0]!==undefined?arguments[0]:10;var randPassword=Array(length).fill("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz").map(function(x){return x[Math.floor(Math.random()*x.length)];}).join('');return randPassword;}function encrypt(content,password){return escape(CryptoJS.AES.encrypt(content,password).toString());}function decrypt(content,password){
...
},{}],"global-input-message":[function(require,module,exports){
Object.defineProperty(exports,"__esModule",{value:true});exports.createMessageConnector=exports.decrypt=exports.encrypt=exports.generatateRandomString=undefined;var _GlobalInputMessageConnector=require("./GlobalInputMessageConnector");var _GlobalInputMessageConnector2=_interopRequireDefault(_GlobalInputMessageConnector);
...
generatateRandomString=_util.generatateRandomString;exports.encrypt=_util.encrypt;exports.decrypt=_util.decrypt;exports.createMessageConnector=createMessageConnector;
