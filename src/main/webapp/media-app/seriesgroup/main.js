                    ...
                    boxservice.seriesgroup.listdata.autoScroll();
                        $(".seriesgrouplink").click(function(){
                                var deferred=boxservice.seriesgroup.listdata.getBackDeferred();
																var recordContainer=$(this).parents(".collectionrow");
															 var collectionid=recordContainer.attr("collectionid");
															 boxservice.router.editCollection.onClicked(collectionid,deferred);
